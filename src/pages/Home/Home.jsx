...
<Link 
  ...
  style={{ backgroundImage: `linear-gradient(#16a0847d, transparent 80%), linear-gradient(0deg,#8080da7c, transparent 80%), url(${card1Bg})` }}
>
    <h3>Valle Crucis</h3>
</Link>
...
<Link 
  ...
  style={{ backgroundImage: `linear-gradient(#16a0847d, transparent 80%), linear-gradient(0deg,#8080da7c, transparent 80%), url(${card2Bg})` }}
>
    <h3>still lifes</h3>
</Link>
        </div>
